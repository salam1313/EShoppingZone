...
namespace EshoppingZoneAPI.Controllers
{
    ...
    public class MerchantAuthController : ControllerBase
    {
        ...
        public MerchantAuthController(IAuthService authService)
        {
        ...
        public async Task<IActionResult> Register([FromBody] AuthRegisterDTO dto)
        {
            ...
            var result = await _authService.Register(dto, "Merchant");
        ...
        public async Task<IActionResult> Login([FromBody] AuthLoginDTO dto)
        {
            ...
            var result = await _authService.Login(dto, "Merchant");
            if (result == null)
